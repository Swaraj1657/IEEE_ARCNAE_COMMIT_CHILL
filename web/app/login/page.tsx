  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white flex items-center justify-center px-4">
      <div className="w-full max-w-md rounded-xl bg-white/5 p-6 border border-white/10 shadow">
        ...
        <p className="text-sm text-slate-300 mb-6">Sign in to access your dashboard</p>
        ...
        <p className="text-xs text-slate-400 mt-4">Don’t have an account? <a className="text-emerald-300" href="/signup">Sign up</a></p>
      </div>
    </div>
  );
}